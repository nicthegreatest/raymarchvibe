...
// Utils.h will be included in ShaderParser.cpp where Trim is used.

using json = nlohmann::json;

// Structure to hold information about #define controls
...
// Structure to hold information about Shadertoy-style uniform controls from metadata
...
// Structure for global const variable controls
...
private:
    ...
    // static std::string trim(const std::string& str); // <<< Ensure this is REMOVED
};

// #endif // SHADERPARSER_H // This was correctly removed earlier due to #pragma once
